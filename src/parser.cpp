...
const QString Int8::Type = QLatin1String("Int8");
const QString UInt8::Type = QLatin1String("UInt8");
const QString Int16::Type = QLatin1String("Int16");
const QString UInt16::Type = QLatin1String("UInt16");
const QString UInt24::Type = QLatin1String("UInt24");
const QString UInt32::Type = QLatin1String("UInt32");
const QString Tag::Type = QLatin1String("Tag");
const QString Fixed::Type = QLatin1String("Fixed");
const QString F2DOT14::Type = QLatin1String("F2DOT14");
const QString Offset16::Type = QLatin1String("Offset16");
const QString Offset32::Type = QLatin1String("Offset32");
const QString GlyphId::Type = QLatin1String("GlyphId");
const QString LongDateTime::Type = QLatin1String("LongDateTime");
const QString CFFCommon::OffsetSize::Type = QLatin1String("OffsetSize");
const QString NameCommon::PlatformID::Type = QLatin1String("Platform ID");
...
QString NameCommon::encodingName(const PlatformID platform, const quint16 id)
{
    switch (platform) {
...
QString NameCommon::languageName(const PlatformID platform, const quint16 id)
{
    switch (platform) {
